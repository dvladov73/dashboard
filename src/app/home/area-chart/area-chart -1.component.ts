...
export class AreaChartComponent implements OnInit, OnChanges {
    ...
    private processData(data) {
        this.bins = [];
        data.forEach((sales) => {
            this.bins.push(this.histogram(sales))
        });
    }
    ...
    private setColorScale() {
       // this.colorScale = d3.scaleOrdinal(d3.schemeCategory10);
        ...
        this.colorScale = d3.scaleOrdinal().domain(['Prod1','Prod2','Prod3','Total Sales']).range(['#04b300', '#ff7f0e', '#2ca02c', '#d62728']);
    }
